# BlueOasis — AI context

> `CLAUDE.md` et `AGENTS.md` sont **le même fichier** (lien physique, un seul inode) :
> Claude Code, Codex, Cursor, Antigravity. Editer l'un edite l'autre, dans les deux sens.
> `.github/copilot-instructions.md` est une copie distincte : Copilot exige une autre
> syntaxe de references, il ne peut pas partager le fichier.
